  ...
  <div class="max-w-[1320px] mx-auto px-5 sm:px-8">
    ...
    <div class="pt-12 flex flex-wrap items-end justify-between gap-4">
      <div>
        ...
        <p class="mt-3 max-w-2xl text-[16.5px] leading-relaxed text-ink2">Des articles de contexte pour situer ce dossier&nbsp;: le droit de la franchise, les grandes affaires judiciaires du groupe dans le monde, les jurisprudences. Faits et sources, sans parti pris.</p>
      </div>
